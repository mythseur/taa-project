...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "TAAProject@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TAAProject API";

        private String description = "TAAProject API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TAAProject";
